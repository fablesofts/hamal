...
public class EncryptDES {
    ...
    private final static String DEFAULT_KEY = "c3d4=%5g7";
//    private final static String DB_DES_KEY = "database.password.key";
    
//    static {
//    	String key = HamalPropertyConfigurer.getHamalProperty("DB_DES_KEY");
