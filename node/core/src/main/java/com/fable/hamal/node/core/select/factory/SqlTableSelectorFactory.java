...
import com.fable.hamal.node.core.select.SqlTableSelector;
 ...
 */
public class SqlTableSelectorFactory implements SelectorFactory {

	private static final Logger logger = LoggerFactory.getLogger(SqlTableSelectorFactory.class);
	...
	public Selector createSelector(Pump pump) {
		...
		SqlTableSelector selector = new SqlTableSelector();
