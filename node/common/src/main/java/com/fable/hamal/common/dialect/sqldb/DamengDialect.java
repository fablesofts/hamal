 ...
 */
public class DamengDialect extends AbstractDbDialect {

	public DamengDialect(JdbcTemplate jdbcTemplate, LobHandler lobHandler) {
        super(jdbcTemplate, lobHandler);
    }

    public DamengDialect(JdbcTemplate jdbcTemplate, LobHandler lobHandler, String name, int majorVersion,
                         int minorVersion) {
